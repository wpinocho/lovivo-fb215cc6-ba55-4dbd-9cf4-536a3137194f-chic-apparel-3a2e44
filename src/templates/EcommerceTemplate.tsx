        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="text-background mb-4">
              <span className="font-sans text-2xl tracking-widest font-light">ATELIER</span>
            </div>
          ...
          {/* Links */}
          <div>
            <h3 className="font-serif text-lg mb-4 text-background">Explore</h3>
          ...
          {/* Social Links */}
          <div>
            <h3 className="font-serif text-lg mb-4 text-background">Connect</h3>
            <SocialLinks />
          </div>
        </div>

        <div className="pt-8 border-t border-background/20 text-center">
          <p className="text-background/60 text-sm tracking-wider">
